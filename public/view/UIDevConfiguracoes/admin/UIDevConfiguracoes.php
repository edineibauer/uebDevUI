...
<section class="col padding-8 border-bottom">
    <div class="container">
        <div class="left padding-small padding-16">
            ...
            <button id="create-cache-db" class="btn hover-shadow opacity hover-opacity-off left" style="margin-left: 10px">
                <i class="material-icons left padding-right" title="Recria todos os caches do banco de dados">info</i>
                <span class="left padding-tiny">Limpar Cache do Banco</span>
            </button>
            <button id="updateAppStore" class="btn hover-shadow opacity hover-opacity-off left" style="margin-left: 10px">
                <i class="material-icons left padding-right" title="Cria uma versão de produção front-end do sistema">info</i>
                <span class="left padding-tiny">Pedir aos usuários android para atualizarem</span>
            </button>
        </div>
    </div>
</section>